...
# 待预测图像所在路径
cfg.data_dir = os.path.join(args.example , "data", "F:\Project\PaddleSeg-release-v0.4.0\contrib\HumanSeg\HumanSeg\data\\test_images\\*.png")
# 待预测图像名称列表
cfg.data_list_file = os.path.join(args.example , "data", "test.txt")
# 模型加载路径
cfg.model_path = os.path.join(args.example , "model")
# 预测结果保存路径
cfg.vis_dir = os.path.join(args.example , "F:\Project\PaddleSeg-release-v0.4.0\contrib\HumanSeg\HumanSeg\\result")
